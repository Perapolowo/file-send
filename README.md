...
![File upload example](File_Upload.png)

2. การดาวน์โหลดไฟล์: อนุญาตให้ผู้ใช้ดาวน์โหลดไฟล์จากเซิร์ฟเวอร์
![Example file download](File_Download.png)
...
![Results of K6 example](Results_of_K6.png)
...
![Results of PM2 example](Results_of_PM2.png)
